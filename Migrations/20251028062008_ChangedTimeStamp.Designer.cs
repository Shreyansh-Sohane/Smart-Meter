...
namespace SmartMeterBackend.Migrations
{
    ...
    [Migration("20251028062008_ChangedTimeStamp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Address", b =>
                {
                    b.Property<long>("Aid")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Arrear", b =>
                {
                    b.Property<long>("Aid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Billing", b =>
                {
                    b.Property<long>("Billid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Consumer", b =>
                {
                    b.Property<long>("Consumerid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Meter", b =>
                {
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Meterreading", b =>
                {
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Orgunit", b =>
                {
                    b.Property<int>("Orgunitid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Tariff", b =>
                {
                    b.Property<int>("Tariffid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Tariffdetail", b =>
                {
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Tariffslab", b =>
                {
                    b.Property<int>("Tariffslabid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Todrule", b =>
                {
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.User", b =>
                {
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Arrear", b =>
                {
                    b.HasOne("SmartMeterBackend.Models.Billing", "Bill")
                        .WithMany("Arrears")
                        .HasForeignKey("Billid")
                        .IsRequired()
                        .HasConstraintName("arrears_billid_fkey");

                    b.HasOne("SmartMeterBackend.Models.Consumer", "Consumer")
                        .WithMany("Arrears")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Billing", b =>
                {
                    ...
                    b.HasOne("SmartMeterBackend.Models.Meter", "Meter")
                        .WithMany("Billings")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Consumer", b =>
                {
                    b.HasOne("SmartMeterBackend.Models.Address", "AidNavigation")
                        .WithMany("Consumers")
                        .HasForeignKey("Aid")
                        .HasConstraintName("consumer_aid_fkey");

                    b.HasOne("SmartMeterBackend.Models.Orgunit", "Orgunit")
                        .WithMany("Consumers")
                        .HasForeignKey("Orgunitid")
                        .IsRequired()
                        .HasConstraintName("consumer_orgunitid_fkey");

                    b.HasOne("SmartMeterBackend.Models.Tariff", "Tariff")
                        .WithMany("Consumers")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Orgunit", b =>
                {
                    b.HasOne("SmartMeterBackend.Models.Orgunit", "Parent")
            ...
            modelBuilder.Entity("SmartMeterBackend.Models.Tariffdetail", b =>
                {
                    ...
                    b.HasOne("SmartMeterBackend.Models.Tariffslab", "Tariffslab")
                        .WithMany("Tariffdetails")
                        .HasForeignKey("Tariffslabid")
                        .IsRequired()
                        .HasConstraintName("tariffdetails_tariffslabid_fkey");

                    b.HasOne("SmartMeterBackend.Models.Todrule", "Tarifftod")
                        .WithMany("Tariffdetails")
